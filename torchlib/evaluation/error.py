...
def mse(X, Y, cdim=None, dim=None, reduction='mean'):
...
def sse(X, Y, cdim=None, dim=None, reduction='mean'):
...
def mae(X, Y, cdim=None, dim=None, reduction='mean'):
...
def sae(X, Y, cdim=None, dim=None, reduction='mean'):
