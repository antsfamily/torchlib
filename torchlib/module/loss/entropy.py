...
class EntropyLoss(th.nn.Module):
    ...
    ::
        ...
        # real
        S1 = EntropyLoss(cdim=None, dim=(-2, -1), mode='shannon', reduction=None)(X)
        S2 = EntropyLoss(cdim=None, dim=(-2, -1), mode='shannon', reduction='sum')(X)
        S3 = EntropyLoss(cdim=None, dim=(-2, -1), mode='shannon', reduction='mean')(X)
        print(S1, S2, S3)

        # complex in real format
        S1 = EntropyLoss(cdim=1, dim=(-2, -1), mode='shannon', reduction=None)(X)
        S2 = EntropyLoss(cdim=1, dim=(-2, -1), mode='shannon', reduction='sum')(X)
        S3 = EntropyLoss(cdim=1, dim=(-2, -1), mode='shannon', reduction='mean')(X)
        print(S1, S2, S3)
