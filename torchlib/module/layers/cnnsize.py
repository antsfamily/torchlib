...
if __name__ == '__main__':
    ...
    CHWo = tl.ConvSize2d(CHWi=CHWi, Co=Co, K=K,
                          S=S, P=P, D=D)
    print(CHWo)
    ...
    CHWo = tl.ConvTransposeSize2d(CHWi=CHWo, Co=CHWi[0], K=K,
                                   S=S, P=P, D=D, OP=OP)
    print('---Theoretical result')
    print(CHWo)
    ...
    print("===Pool2d")
    print('---Theoretical result')
    CHWo = tl.PoolSize2d(CHWi, K, S, P, D=D)
    print(CHWo)
    print('---Torch result')
    ...
    print("===UnPool2d")
    print('---Theoretical result')
    CHWo = tl.UnPoolSize2d(CHWo, K, S, P, D=D)
    print(CHWo)
    print('---Torch result')
