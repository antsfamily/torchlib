...
if __name__ == '__main__':
    ...
    SPfunction = tht.spfunction.Binary()
    Voptimizer = tht.voptimizer.Binary()
    ...
    SPfunction = tht.spfunction.Linear()
    Voptimizer = tht.voptimizer.Linear()
    Voptimizer.step(loss)
    fv = SPfunction.eval(Voptimizer.v, Voptimizer.lmbd)
    print("---fv,", fv)
    ...
    SPfunction = tht.spfunction.Logarithmic()
    Voptimizer = tht.voptimizer.Logarithmic()
    Voptimizer.step(loss)
    fv = SPfunction.eval(Voptimizer.v, Voptimizer.lmbd)
    print("---fv,", fv)
    ...
    SPfunction = tht.spfunction.Mixture()
    Voptimizer = tht.voptimizer.Mixture()
    Voptimizer.step(loss)
